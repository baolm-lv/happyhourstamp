 ...
 */
@Repository
public interface StampRefundOrderRepository extends JpaRepository<StampRefundOrderEntity, String> {
	...
	List<StampRefundOrderEntity> getByOrderId(String orderId);
}
